...
public class PartyReadResponseDto {
    ...
    public static PartyReadResponseDto createDto(Party party, Long userId, List<String> hashtags, List<Party> parties) {
...
/*        List<String> hashtagsDto = hashtags.stream()
        ...
        PartyReadResponseDto partyReadResponseDto =  PartyReadResponseDto.builder()
                //.ownerNickname(party.getOwner().getNickname())
                ...
                .hashtags(hashtags)
                //.isOwner((party.getOwner().getId())==userId)
                .isMember(isMember)
