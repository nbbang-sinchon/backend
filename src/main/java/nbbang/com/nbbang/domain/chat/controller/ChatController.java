...
public class ChatController {
    ...
    public DefaultResponse select(@PathVariable("party-id") Long partyId, @RequestParam(required = false) Integer pageSize, HttpServletResponse response) {
        ...
        return DefaultResponse.res(StatusCode.OK, ChatResponseMessage.READ_CHAT, ChatResponseDto.createByPartyEntity(party, lastMessage.getId(), messages.getContent()));
    }
    ...
    public DefaultResponse changeStatus(@PathVariable("party-id") Long partyId,
        ...
        chatService.changeStatus(party, member, chatStatusChangeRequestDto.createStatus());
